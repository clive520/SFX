...
All downloaded audio files are stored in `assets/audio/` and are used under the Mixkit Stock Music Free License or Mixkit Sound Effects Free License.

Source license page: https://mixkit.co/license/
...
| 沉重純音樂 | `assets/audio/heavy-music.mp3` | Dark Shadows | Ahjay Stelino | Mixkit Stock Music Free License |

## Short Sound Effects

| Site label | Local file | Source | Source page | License |
| --- | --- | --- | --- | --- |
| 來回踱步 | `assets/audio/short/pacing-footsteps.mp3` | Footsteps in a tunnel loop | https://mixkit.co/free-sound-effects/footsteps/ | Mixkit Sound Effects Free License |
| 乒乓掉落 | `assets/audio/short/clattering-drop.mp3` | Falling bricks | https://mixkit.co/free-sound-effects/falling/ | Mixkit Sound Effects Free License |
| 打雷聲 | `assets/audio/short/thunder-rumble.mp3` | Big thunder rumble | https://mixkit.co/free-sound-effects/thunder/ | Mixkit Sound Effects Free License |
